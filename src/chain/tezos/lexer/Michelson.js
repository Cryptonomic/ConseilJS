...
var grammar = {
    ...
    {"name": "subTypeData", "symbols": [{"literal":"{}"}], "postprocess": d => "[]"},
    ...
    {"name": "subTypeElt", "symbols": [{"literal":"{}"}], "postprocess": d => "[]"},
    ...
    {"name": "subData", "symbols": [{"literal":"{}"}], "postprocess": d => "[]"},
    ...
    {"name": "subElt", "symbols": [{"literal":"{}"}], "postprocess": d => "[]"},
