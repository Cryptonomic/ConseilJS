...
describe("signOperationGroup() and computeOperationHash()", () => {
  ...
  it("correctly parse a reveal from binary", () => {
  ...
  it("correctly parse an operation group from binary", () => {
  ...
  it("correctly parse an origination from binary", () => {
  ...
  it("correctly parse an origination with contract from binary", () => {
