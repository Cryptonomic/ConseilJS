...
*Defined in [chain/tezos/TezosNodeWriter.ts:163](https://github.com/Cryptonomic/ConseilJS/blob/b4f6349/src/chain/tezos/TezosNodeWriter.ts#L163)*
...
*Defined in [chain/tezos/TezosNodeWriter.ts:88](https://github.com/Cryptonomic/ConseilJS/blob/b4f6349/src/chain/tezos/TezosNodeWriter.ts#L88)*
...
*Defined in [chain/tezos/TezosNodeWriter.ts:72](https://github.com/Cryptonomic/ConseilJS/blob/b4f6349/src/chain/tezos/TezosNodeWriter.ts#L72)*
...
*Defined in [chain/tezos/TezosNodeWriter.ts:127](https://github.com/Cryptonomic/ConseilJS/blob/b4f6349/src/chain/tezos/TezosNodeWriter.ts#L127)*
...
*Defined in [chain/tezos/TezosNodeWriter.ts:268](https://github.com/Cryptonomic/ConseilJS/blob/b4f6349/src/chain/tezos/TezosNodeWriter.ts#L268)*
...
▸ **sendContractInvocationOperation**(server: *`string`*, keyStore: *[KeyStore](../interfaces/keystore.md)*, to: *`string`*, amount: *`number`*, fee: *`number`*, derivationPath: *`string`*, storageLimit: *`number`*, gasLimit: *`number`*, parameters?: *`undefined` \| `string`*): `Promise`<[OperationResult](../interfaces/operationresult.md)>

*Defined in [chain/tezos/TezosNodeWriter.ts:385](https://github.com/Cryptonomic/ConseilJS/blob/b4f6349/src/chain/tezos/TezosNodeWriter.ts#L385)*
...
▸ **sendContractOriginationOperation**(server: *`string`*, keyStore: *[KeyStore](../interfaces/keystore.md)*, amount: *`number`*, delegate: *`string` \| `undefined`*, spendable: *`boolean`*, delegatable: *`boolean`*, fee: *`number`*, derivationPath: *`string`*, storage_limit: *`string`*, gas_limit: *`string`*, code: *`string`*, storage: *`string`*): `Promise`<[OperationResult](../interfaces/operationresult.md)>

*Defined in [chain/tezos/TezosNodeWriter.ts:297](https://github.com/Cryptonomic/ConseilJS/blob/b4f6349/src/chain/tezos/TezosNodeWriter.ts#L297)*
...
| keyStore | [KeyStore](../interfaces/keystore.md) |  Key pair along with public key hash |
| amount | `number` |  Initial funding amount of new account |
| delegate | `string` \| `undefined` |  Account ID to delegate to, blank if none |
| spendable | `boolean` |  Is account spendable? |
| delegatable | `boolean` |  Is account delegatable? |
| fee | `number` |  Operation fee |
| derivationPath | `string` |  BIP44 Derivation Path if signed with hardware, empty if signed with software |
...
| storage | `string` |  Initial storage value. |
...
*Defined in [chain/tezos/TezosNodeWriter.ts:232](https://github.com/Cryptonomic/ConseilJS/blob/b4f6349/src/chain/tezos/TezosNodeWriter.ts#L232)*
...
*Defined in [chain/tezos/TezosNodeWriter.ts:457](https://github.com/Cryptonomic/ConseilJS/blob/b4f6349/src/chain/tezos/TezosNodeWriter.ts#L457)*
...
*Defined in [chain/tezos/TezosNodeWriter.ts:427](https://github.com/Cryptonomic/ConseilJS/blob/b4f6349/src/chain/tezos/TezosNodeWriter.ts#L427)*
...
*Defined in [chain/tezos/TezosNodeWriter.ts:143](https://github.com/Cryptonomic/ConseilJS/blob/b4f6349/src/chain/tezos/TezosNodeWriter.ts#L143)*
...
*Defined in [chain/tezos/TezosNodeWriter.ts:195](https://github.com/Cryptonomic/ConseilJS/blob/b4f6349/src/chain/tezos/TezosNodeWriter.ts#L195)*
...
*Defined in [chain/tezos/TezosNodeWriter.ts:42](https://github.com/Cryptonomic/ConseilJS/blob/b4f6349/src/chain/tezos/TezosNodeWriter.ts#L42)*
